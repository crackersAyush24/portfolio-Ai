      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-2 hover:scale-105 hover:rotateX-5 transition-all duration-300 flex items-center gap-2 perspective-1000">
              <Download size={20} />
              Download Resume
            </button>
            <button 
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://github.com/crackersAyush24?tab=repositories" className="text-gray-600 hover:text-blue-600 transform hover:scale-110 hover:rotateY-12 hover:-translate-y-1 transition-all duration-300 perspective-1000">
              <Github size={28} />
            </a>
            <a href="https://www.linkedin.com/in/ayush-chaubey-90751422b" className="text-gray-600 hover:text-blue-600 transform hover:scale-110 hover:rotateY-12 hover:-translate-y-1 transition-all duration-300 perspective-1000">
              <Linkedin size={28} />
            </a>
            <a href="mailto:chaubeyayush04@gmail.com" className="text-gray-600 hover:text-blue-600 transform hover:scale-110 hover:rotateY-12 hover:-translate-y-1 transition-all duration-300 perspective-1000">
              <Mail size={28} />
            </a>
          </div>
        </div>
